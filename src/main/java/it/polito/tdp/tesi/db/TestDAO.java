...
public class TestDAO {
	...
	public static void main(String[] args) {
		...
		System.out.println("Il prodotto 12451C è stato oradinato "+ordini.size()+" volte");
		System.out.println("\nId prodotto: 12451C Anno: 2018");
		HashMap<Integer, Integer> ordiniMese = new HashMap<Integer, Integer>();
